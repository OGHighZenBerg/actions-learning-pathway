...
This application is automatically built, tested, and deployed to GitHub Pages using GitHub Actions. The workflow is defined in `.github/workflows/deploy.yml`.